...
#ifndef __NEUROMORE_BRAINALIVE_H
#define __NEUROMORE_BRAINALIVE_H
...
public:
	...
	void AddDevice(BrainAliveDeviceBase* device, const char* serialPort);
...
private:
	...
	BrainAliveAutoDetection* mAutoDetection;
...
class BrainAliveSerialThread : public QThread
{
	Q_OBJECT
public:
	BrainAliveSerialThread(BrainAliveDeviceBase* device, const char* serialPortName) : mDevice(device), mPortName(serialPortName) { moveToThread(this); }
