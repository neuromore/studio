...
class Kernel : public QMatrixSVM
{
public:
...
public:
    ...
    void Solve (int l, const QMatrixSVM &Q, const double *p_, const schar *y_, double *alpha_,
...
void Solver::Solve (int l, const QMatrixSVM &Q, const double *p_, const schar *y_, double *alpha_,
    double Cp, double Cn, double eps, SolutionInfo *si, int shrinking)
{
    this->l = l;
    this->Q = &Q;
...
public:
    ...
    void Solve (int l, const QMatrixSVM &Q, const double *p, const schar *y, double *alpha, double Cp,
