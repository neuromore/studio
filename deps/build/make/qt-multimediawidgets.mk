...
NAME       = qt-multimediawidgets
INCDIR     = ../../include
INCDIRQT   = $(INCDIR)/qt/QtMultimediaWidgets
SRCDIR     = ../../src/$(NAME)
MOCDIR     = $(SRCDIR)/.moc
RCCDIR     = $(SRCDIR)/.rcc
UICDIR     = $(SRCDIR)/.uic
...
LINKPATH  := $(LINKPATH)
LINKLIBS  := $(LINKLIBS)
MOCH       = qcameraviewfinder.cpp \
             qgraphicsvideoitem.cpp \
             private/qpaintervideosurface_p.cpp \
             qvideowidget.cpp \
             private/qvideowidget_p.cpp \
...
RCCO       =
UICH       =
OBJS       = qcameraviewfinder.o \
             qgraphicsvideoitem.o \
             qpaintervideosurface.o \
             qvideowidget.o \
             qvideowidgetcontrol.o
