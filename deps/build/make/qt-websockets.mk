...
NAME       = qt-websockets
INCDIR     = ../../include
INCDIRQT   = $(INCDIR)/qt/QtWebSockets
SRCDIR     = ../../src/$(NAME)
MOCDIR     = $(SRCDIR)/.moc
RCCDIR     = $(SRCDIR)/.rcc
UICDIR     = $(SRCDIR)/.uic
...
LINKPATH  := $(LINKPATH)
LINKLIBS  := $(LINKLIBS)
MOCH       = private/qsslserver_p.cpp \
             private/qwebsocketdataprocessor_p.cpp \
             private/qwebsockethandshakeresponse_p.cpp \
             qwebsocket.cpp \
...
RCCO       =
UICH       =
OBJS       = qdefaultmaskgenerator_p.o \
             qmaskgenerator.o \
             qsslserver.o \
             qwebsocket.o \
             qwebsocket_p.o \
             qwebsocketcorsauthenticator.o \
             qwebsocketdataprocessor.o \
             qwebsocketframe.o \
             qwebsockethandshakerequest.o \
             qwebsockethandshakeresponse.o \
             qwebsocketprotocol.o \
             qwebsocketserver.o \
             qwebsocketserver_p.o \
