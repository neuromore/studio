...
NAME       = qt-eventdispatchers
INCDIR     = ../../include
INCDIRQT   = $(INCDIR)/qt/QtEventDispatcherSupport
SRCDIR     = ../../src/$(NAME)
MOCDIR     = $(SRCDIR)/.moc
RCCDIR     = $(SRCDIR)/.rcc
UICDIR     = $(SRCDIR)/.uic
...
MOCH      := $(MOCH) private/qwindowsguieventdispatcher_p.cpp
MOCC      := $(MOCC)
MOCO      := $(MOCO) qwindowsguieventdispatcher_p.omoc
RCCH      := $(RCCH)
RCCO      := $(RCCO)
UICH      := $(UICH)
OBJS      := $(OBJS) qwindowsguieventdispatcher.o
ifeq ($(TARGET_ARCH),x86)
DEFINES   := $(DEFINES)
endif
ifeq ($(TARGET_ARCH),x64)
