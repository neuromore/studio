...
// defines which sensors to include in the different builds :
#ifndef PRODUCTION_BUILD

	// devices on all platforms
	...
	#define INCLUDE_DEVICE_OYMOTION_GFORCE
	#define INCLUDE_DEVICE_BRAINBIT_EEG
#endif
