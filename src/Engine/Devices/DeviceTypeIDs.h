...
class ENGINE_API DeviceTypeIDs
{
	public:
		...
		enum EDeviceTypeID
		{
			...
			DEVICE_TYPEID_EEMAGINE_EE211				= 0x0921,   // 092X = eemagine
			DEVICE_TYPEID_EEMAGINE_EE212				= 0x0922,
			DEVICE_TYPEID_EEMAGINE_EE213				= 0x0923,
			DEVICE_TYPEID_EEMAGINE_EE214				= 0x0924,
			DEVICE_TYPEID_EEMAGINE_EE215				= 0x0925,
			DEVICE_TYPEID_EEMAGINE_EE221				= 0x0926,
			DEVICE_TYPEID_EEMAGINE_EE222				= 0x0927,
			DEVICE_TYPEID_EEMAGINE_EE223				= 0x0928,
			DEVICE_TYPEID_EEMAGINE_EE224				= 0x0929,
			DEVICE_TYPEID_EEMAGINE_EE225				= 0x092A,
			DEVICE_TYPEID_EEMAGINE_EE410				= 0x092B,
			DEVICE_TYPEID_EEMAGINE_EE411				= 0x092C,
			DEVICE_TYPEID_EEMAGINE_EE430				= 0x092D,
