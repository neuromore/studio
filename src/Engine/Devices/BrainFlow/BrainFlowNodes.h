...
{
	public:
		enum { TYPE_ID = 0xD00000 | BrainFlowDeviceCyton::TYPE_ID };
		...
		const char* GetReadableType() const override							{ return "BrainFlowCyton"; }
		const char* GetRuleName() const override final							{ return BrainFlowDeviceCyton::GetRuleName(); }
