...
// constructor
VignetteControlNode::VignetteControlNode(Graph* parentGraph) : CustomFeedbackNode(parentGraph)
{
}


// destructor
VignetteControlNode::~VignetteControlNode()
{
}


// initialize
void VignetteControlNode::Init()
{
	AddOutput();
...
void VignetteControlNode::ReInit(const Time& elapsed, const Time& delta)
{
...
void VignetteControlNode::Reset()
{
	FeedbackNode::Reset();
}
...
// update the node
void VignetteControlNode::Update(const Time& elapsed, const Time& delta)
{
...
void VignetteControlNode::OnAttributesChanged()
{
}


double VignetteControlNode::GetCurrentValue(uint32 channelIndex) const
{
...
bool VignetteControlNode::IsEmpty(uint32 channelIndex) const
{
	CORE_ASSERT(channelIndex <= mInputReader.GetNumChannels());
...
void VignetteControlNode::HideAttributes()
{
...
void VignetteControlNode::SetName(const char* name)
{
