...
// constructor
RainControlNode::RainControlNode(Graph* parentGraph) : CustomFeedbackNode(parentGraph)
{
}


// destructor
RainControlNode::~RainControlNode()
{
}


// initialize
void RainControlNode::Init()
{
	AddOutput();
...
void RainControlNode::ReInit(const Time& elapsed, const Time& delta)
{
...
// update the node
void RainControlNode::Update(const Time& elapsed, const Time& delta)
{
...
void RainControlNode::OnAttributesChanged()
{
}


double RainControlNode::GetCurrentValue(uint32 channelIndex) const
{
...
bool RainControlNode::IsEmpty(uint32 channelIndex) const
{
	CORE_ASSERT(channelIndex <= mInputReader.GetNumChannels());
...
void RainControlNode::HideAttributes()
{
...
void RainControlNode::SetName(const char* name)
{
