...
// constructor
CloudsControlNode::CloudsControlNode(Graph* parentGraph) : CustomFeedbackNode(parentGraph)
{
}


// destructor
CloudsControlNode::~CloudsControlNode()
{
}


// initialize
void CloudsControlNode::Init()
{
	AddOutput();
...
void CloudsControlNode::ReInit(const Time& elapsed, const Time& delta)
{
...
// update the node
void CloudsControlNode::Update(const Time& elapsed, const Time& delta)
{
...
void CloudsControlNode::OnAttributesChanged()
{
}


double CloudsControlNode::GetCurrentValue(uint32 channelIndex) const
{
...
bool CloudsControlNode::IsEmpty(uint32 channelIndex) const
{
	CORE_ASSERT(channelIndex <= mInputReader.GetNumChannels());
...
void CloudsControlNode::HideAttributes()
{
...
void CloudsControlNode::SetName(const char* name)
{
