...
// constructor
StateTransitionVideoCondition::StateTransitionVideoCondition(Graph* graph) : StateTransitionCondition(graph)
{
	Reset();
}
...
// destructor
StateTransitionVideoCondition::~StateTransitionVideoCondition()
{
}


// register the attributes
void StateTransitionVideoCondition::Init()
{
	// register attributes
	...
	AttributeSettings* numLoopsAttribute = RegisterAttribute("Num Loops", "numLoops", "The number of loops the video needs to play before the condition switches.", ATTRIBUTE_INTERFACETYPE_INTSPINNER);
...
void StateTransitionVideoCondition::Update(const Time& elapsed, const Time& delta)
{
}


// reset the condition
void StateTransitionVideoCondition::Reset()
{
	mLoops = 0;
}
...
// test the condition
bool StateTransitionVideoCondition::TestCondition()
{
...
void StateTransitionVideoCondition::OnAttributesChanged()
{
