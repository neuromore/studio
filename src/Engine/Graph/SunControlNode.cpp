...
// constructor
SunControlNode::SunControlNode(Graph* parentGraph) : CustomFeedbackNode(parentGraph)
{
}


// destructor
SunControlNode::~SunControlNode()
{
}


// initialize
void SunControlNode::Init()
{
	AddOutput();
...
void SunControlNode::ReInit(const Time& elapsed, const Time& delta)
{
...
// update the node
void SunControlNode::Update(const Time& elapsed, const Time& delta)
{
...
void SunControlNode::OnAttributesChanged()
{
}


double SunControlNode::GetCurrentValue(uint32 channelIndex) const
{
...
bool SunControlNode::IsEmpty(uint32 channelIndex) const
{
	CORE_ASSERT(channelIndex <= mInputReader.GetNumChannels());
...
void SunControlNode::HideAttributes()
{
...
void SunControlNode::SetName(const char* name)
{
