...
// constructor
FogControlNode::FogControlNode(Graph* parentGraph) : CustomFeedbackNode(parentGraph)
{
}


// destructor
FogControlNode::~FogControlNode()
{
}


// initialize
void FogControlNode::Init()
{
	AddOutput();
...
void FogControlNode::ReInit(const Time& elapsed, const Time& delta)
{
...
// update the node
void FogControlNode::Update(const Time& elapsed, const Time& delta)
{
...
void FogControlNode::OnAttributesChanged()
{
}


double FogControlNode::GetCurrentValue(uint32 channelIndex) const
{
...
bool FogControlNode::IsEmpty(uint32 channelIndex) const
{
	CORE_ASSERT(channelIndex <= mInputReader.GetNumChannels());
...
void FogControlNode::HideAttributes()
{
...
void FogControlNode::SetName(const char* name)
{
