...
// constructor
ScreenBrightnessNode::ScreenBrightnessNode(Graph* parentGraph) : CustomFeedbackNode(parentGraph)
{
}


// destructor
ScreenBrightnessNode::~ScreenBrightnessNode()
{
}


// initialize
void ScreenBrightnessNode::Init()
{
	AddOutput();
...
void ScreenBrightnessNode::ReInit(const Time& elapsed, const Time& delta)
{
...
void ScreenBrightnessNode::Reset()
{
	FeedbackNode::Reset();
}
...
// update the node
void ScreenBrightnessNode::Update(const Time& elapsed, const Time& delta)
{
...
void ScreenBrightnessNode::OnAttributesChanged()
{
}


double ScreenBrightnessNode::GetCurrentValue(uint32 channelIndex) const
{
...
bool ScreenBrightnessNode::IsEmpty(uint32 channelIndex) const
{
	CORE_ASSERT(channelIndex <= mInputReader.GetNumChannels());
...
void ScreenBrightnessNode::HideAttributes()
{
...
void ScreenBrightnessNode::SetName(const char* name)
{
