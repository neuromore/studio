...
// constructor
HeatmapPlugin::HeatmapPlugin() : Plugin(GetStaticTypeUuid())
{
	LogDetailedInfo("Constructing heatmap plugin ...");
	mHeatmapWidget = NULL;
}
...
{
	LogDetailedInfo("Destructing heatmap plugin ...");
}


// initialize
bool HeatmapPlugin::Init()
{
	LogDetailedInfo("Initializing heatmap plugin ...");
	...
	mHeatmapWidget = new HeatmapWidget(this, mainWidget);
	SetRealtimeWidget( mHeatmapWidget );
	
	///////////////////////////////////////////////////////////////////////////
	// Fill everything
	///////////////////////////////////////////////////////////////////////////
	FillLayouts(mainWidget, mainLayout, toolbarWidgets, "Settings", "Gear", mHeatmapWidget);
	
	LogDetailedInfo("Heatmap successfully initialized");
...
void HeatmapPlugin::RegisterAttributes()
{
