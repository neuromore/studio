...
// constructor
ExampleOpenGLPlugin::ExampleOpenGLPlugin() : Plugin(GetStaticTypeUuid())
{
...
// destructor
ExampleOpenGLPlugin::~ExampleOpenGLPlugin()
{
...
bool ExampleOpenGLPlugin::Init()
{
	...
	mExampleWidget = new ExampleOpenGLWidget(this, mainWidget);
	SetRealtimeWidget( mExampleWidget );
	
	///////////////////////////////////////////////////////////////////////////
	// Fill everything
	///////////////////////////////////////////////////////////////////////////
	FillLayouts(mainWidget, mainLayout, toolbarWidgets, "Settings", "Gear", mExampleWidget);
...
void ExampleOpenGLPlugin::RegisterAttributes()
{
