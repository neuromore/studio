...
#include "../BackendFileSystem/BackendFileSystemWidget.h"

using namespace Core;

// constructor
CreateExperienceWindow::CreateExperienceWindow(const char* windowTitle, const char* defaultLabelText, QWidget* parent) : QDialog(parent)
{
...
// destructor
CreateExperienceWindow::~CreateExperienceWindow()
{
}

void CreateExperienceWindow::OnTextChanged(const QString& newText)
{
