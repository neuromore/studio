...
DEFINE_ATTRIBUTEWIDGETCREATOR( TextAttributeWidgetCreator,			TextAttributeWidget,			Core::ATTRIBUTE_INTERFACETYPE_TEXT,			Core::ATTRIBUTE_INTERFACETYPE_TEXT,			Core::ATTRIBUTE_INTERFACETYPE_TEXT,			Core::AttributeText::TYPE_ID,			false, 	true,	"Text" );
